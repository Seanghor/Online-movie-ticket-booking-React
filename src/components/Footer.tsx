                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li className="mb-4">
                                    <a href="/cinema" className="hover:underline font-poppins">Cinema</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li>
                                    <a href="" className="hover:underline font-poppins">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold uppercase dark:text-white font-poppins">Legal</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="#" className="hover:underline font-poppins">Privacy Policy</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:underline font-poppins">Terms &amp; Conditions</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <span className="sr-only font-poppins">Facebook page</span>
                        </a>
                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <span className="sr-only font-poppins">Discord community</span>
                        </a>
                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <span className="sr-only font-poppins">Dribbble account</span>
                        </a>
                    </div>
                </div>
                {/* Copy Right */}
